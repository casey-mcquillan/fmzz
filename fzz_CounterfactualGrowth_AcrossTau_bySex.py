...
output_path = main_folder+'/output/Tables/Counterfactual Growth'
...
# (model_year2.w2_n_m * (model_year2.share_workers2_n_m/(model_year2.share_workers2_n_m+model_year2.share_workers2_n_f)) +\
#  model_year2.w2_n_f * (model_year2.share_workers2_n_f/(model_year2.share_workers2_n_m+model_year2.share_workers2_n_f))) \
# - \
# (model_year1.w2_n_m * (model_year1.share_workers2_n_m/(model_year1.share_workers2_n_m+model_year1.share_workers2_n_f)) +\
#  model_year1.w2_n_f * (model_year1.share_workers2_n_f/(model_year1.share_workers2_n_m+model_year1.share_workers2_n_f)))
