...
for tau_param in tau_params:
    ...
    chg_w_C = model_year2.avg_w2_c-model_year1.avg_w2_c
    chg_w_N = model_year2.avg_w2_n-model_year1.avg_w2_n
    chg_cwp = 100*((model_year2.avg_w2_c/model_year2.avg_w2_n)-(model_year1.avg_w2_c/model_year1.avg_w2_n))
    chg_P_C = 100*(model_year2.avg_P2_c-model_year1.avg_P2_c)
    chg_P_N = 100*(model_year2.avg_P2_n-model_year1.avg_P2_n)
    chg_employment_C = ((model_year2.employment2_c_m+model_year2.employment2_c_f)-(model_year1.employment2_c_m+model_year1.employment2_c_f))/1e6
    chg_employment_N = ((model_year2.employment2_n_m+model_year2.employment2_n_f)-(model_year1.employment2_n_m+model_year1.employment2_n_f))/1e6
    chg_employment = chg_employment_C+chg_employment_N
    chg_cwb = 100*((((model_year2.L2_c_m+model_year2.L2_c_f)*model_year2.avg_w2_c)/\
                    ((model_year2.L2_c_m+model_year2.L2_c_f)*model_year2.avg_w2_c \
                     + (model_year2.L2_n_m+model_year2.L2_n_f)*model_year2.avg_w2_n))\
                   -(((model_year1.L2_c_m+model_year1.L2_c_f)*model_year1.avg_w2_c)/\
                     ((model_year1.L2_c_m+model_year1.L2_c_f)*model_year1.avg_w2_c \
                      + (model_year1.L2_n_m+model_year1.L2_n_f)*model_year1.avg_w2_n)))
...
file = open(f"Change_OverTime{year2}_{year1}_ByTau_bySex_agg.tex","w")
