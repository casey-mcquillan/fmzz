...
output_path = '/Users/caseymcquillan/Desktop/Research/FZZ/output/Tables/Appendix_RC1/Overview'
...
file = open("RC1_EqComparison_AcrossTau.tex","w")
...
cwd = os.getcwd()
os.chdir(output_path)
file = open("RC1_Overview_Robustness.tex","w")
file.writelines(header) 
