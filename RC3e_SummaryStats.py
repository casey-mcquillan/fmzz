...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  2 11:20:23 2023
...
total_population = OECD_data.loc[year,'Population (25-54)']
...
file = open(f"RC3_SummaryStats_54.tex","w")
