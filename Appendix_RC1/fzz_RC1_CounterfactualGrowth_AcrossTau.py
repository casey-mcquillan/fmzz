...
output_path = '/Users/caseymcquillan/Desktop/Research/FZZ/output/Tables/Appendix_RC1/Counterfactual Growth'
...
cwd = os.getcwd()
os.chdir(output_path)
file = open(f"RC1_Diff_Change_OverTime{year2}_{year1}_ByTau.tex","w")
file.writelines(header) 
file.writelines(table_values)   
file.writelines(closer)   
file.close()